                        ...
                        <table>
                            <tr>                                
                                ...
                                <td id="logica">
                                    <table>
                                        <tr>
                                            <td colspan="2" rowspan="2" class="elemento" onclick="cargarScript('logicaBasica');">
                                                <img onmouseover="clicksound.playclip();" src="Vista/imagenes/objetos/logica.png" class="imagenUniverso" />
                                                <label class="textoUniverso">Lógica</label>   
                                            </td>
                                        </tr>
                                    </table>
                                </td>  
